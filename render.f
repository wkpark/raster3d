...
*
*     Input format(s)
      CHARACTER*80 INFMTS(6),INFMT
*
*     Free-format input flag
      LOGICAL INFLGS(6),INFLG
*
...
*     Copy the info (also error reporting) unit number to common
      ASSOUT = NOISE
      WRITE (NOISE,*) 'Raster3D rendering program V2.0 Apr 1994'
      WRITE (NOISE,*) 'If you publish figures generated by this ',
     &                'program please make reference to'
      WRITE (NOISE,*) 'Bacon & Anderson (1988) and ',
     &                'Merritt & Murphy (1994)'
